...
public class UploadInstallationImageActivity extends AppCompatActivity {
    ...
    String uploadUrl = "http://www.remoteupload.co.in/api/uploadinstallationimage.php";
    String email, id;
    ImageView image;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_upload_installation_image);
    ...
    class AsyncTaskUploadClass extends AsyncTask<Void, Void, String> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            progressDialog = ProgressDialog.show(UploadInstallationImageActivity.this, "Image is " +
                            "Uploading",
        ...
        protected void onPostExecute(String string1) {
            ...
            Toast.makeText(UploadInstallationImageActivity.this, string1, Toast.LENGTH_LONG).show();
            setResult(RESULT_OK);
            finish();
        }
    }
